...
labels = ['UCT', 'MENTS', 'DENTS', 'FPU', 'BEAM', 'MMCTS']
colors_box_plot = ["#8453F7", "#5BE0D1", "#EDC951", "#0838F6A9", "#27AC67A9", "#ED5192"]
colors_hist_plot = ["#8453F7", "#5BE0D1", "#EDC951", "#0838F6A9", "#27AC67A9", "#ED5192"]
...
if __name__ == "__main__":
    ...
    hist_plot(
        data_iters, colors_hist_plot, xlabel="Iterations", ylabel="Count",
        labels=labels, save_path=f"{output_dir}/iterations.png", bins=5
    )
    print("test")
