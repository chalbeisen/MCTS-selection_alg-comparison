...
colors = ["#8453F7", "#5BE0D1", "#EDC951", "#4379C1", "#ED5192"]
labels = ['MCTS with UCT', 'MENTS', 'DENTS', 'BEAM', 'MMCTS']
...
if __name__ == "__main__":
    ...
    progrwid_res = {"best_path": [], "max_reward": [], "best_iter": []}
    ...
    for i in range(nr_of_runs):
        ...
        best_path_beam, max_reward_beam, best_iteration_beam = beam.beam_mcts_search(tsp_env, iterations=iterations, seed=i)
    ...
    #data = [uct_res["max_reward"], ments_res["max_reward"], dents_res["max_reward"], beam_res["max_reward"], progrwid_res["max_reward"],  mmcts_res["max_reward"]]
    data = [uct_res["max_reward"], ments_res["max_reward"], dents_res["max_reward"], beam_res["max_reward"],  mmcts_res["max_reward"]]
    hist_plot(data, colors, xlabel="Minimum cost", ylabel="Count", labels=labels)
    #data = [uct_res["best_iter"], ments_res["best_iter"], dents_res["best_iter"],  beam_res["best_iter"], progrwid_res["best_iter"], mmcts_res["best_iter"]]
    data = [uct_res["best_iter"], ments_res["best_iter"], dents_res["best_iter"],  beam_res["best_iter"], mmcts_res["best_iter"]]
